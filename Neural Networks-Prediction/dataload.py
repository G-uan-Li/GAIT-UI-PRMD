...
def load_data():
    f = open('/root/autodl-tmp/data/m01/Data_Correct_m01.csv')
    csv_f = csv.reader(f)
    ...
    f = open('/root/autodl-tmp/data/m01/Labels_Correct_m01.csv')
    csv_f = csv.reader(f)
    ...
    f = open('/root/autodl-tmp/data/m01/Data_Incorrect_m01.csv')
    csv_f = csv.reader(f)
    ...
    f = open('/root/autodl-tmp/data/m01/Labels_Incorrect_m01.csv')
    csv_f = csv.reader(f)
...
print("1",correct_input.shape)   #  (90, 240, 117)
print(correct_label.shape)   # (90, 1)
print(incorrect_input.shape)  #
